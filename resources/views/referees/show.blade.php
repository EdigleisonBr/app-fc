...
<div class="col-md-12">
    <div class="d-flex justify-content-between">
        ...
        <div class="d-flex flex-row-reverse bd-highlight">
            <div class="d-flex">
                ...
                <div>
                    <a href="/referees/edit/{{$referee->id}}" class="btn btn-warning btn-sm  mr-1"><span data-feather="edit"></span></a> 
                </div>
                <div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::text('name', $referee->name, ['class' => 'form-control','autocomplete' => 'chrome-off', 'readonly']) !!}
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            {!! Form::text('surname', $referee->surname, ['class' => 'form-control','autocomplete' => 'chrome-off', 'readonly']) !!}
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="form-group col-md-3">
            ...
            {!! Form::text('cell', $referee->cell, ['class' => 'form-control celphone', 'required'=>'required', 'readonly']) !!}
        </div>
    </div>           
</div>
@endsection
